...
In this demonstration, we present a new interaction operator 
...
more ``interesting'' parts of a dataset. We also develop techniques to support this operator on increasingly larger datasets:
\squishlist
...
We formally describe our problem in Section~\ref{sec:formal}. Then in Section~\ref{sec:summary}, we describe the components of our system. Finally in Section~\ref{sec:demo}, we outline the demo scenario and describe how users can interact with our system. 