...
In Section~\ref{sec:summary}, we formally describe smart drill-down, and the components of our system. In Section~\ref{sec:demo}, we outline the demo scenario and describe how users can interact with our system. 