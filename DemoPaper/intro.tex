...
In this demonstration, we present a new interaction operator called {\em smart drill down}, that is an extension to a traditional 
...
\squishend
The algorithms used for finding rules to display, and for sample maintainance can be found in our online technical report~\cite{tr}.

We formally describe our problem in Section~\ref{sec:formal}. Then in Section~\ref{sec:system}, we describe the components of our system. Finally in Section~\ref{sec:demo}, we outline the demo scenario and describe how users can interact with our system. 